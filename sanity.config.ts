...
export default defineConfig({
  ...
  plugins: [
    ...
    documentInternationalization({
      ...
      schemaTypes: ['teamPage', 'teamMember', 'solution', 'homePage', 'platformPage', 'productsPage', 'aboutPage', 'careersPage', 'contactPage', 'footer', 'resourcesPage', 'insightsPage', 'insightPost', 'resourcePost', 'blogsPage', 'blogPost'],
